...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-background">
      <div className="w-full max-w-md rounded-2xl border border-border/60 bg-card p-8 shadow-lg text-center space-y-6">
        ...
        <div>
          <h1 className="font-heading text-2xl font-bold tracking-tight">Sign in to Huddl</h1>
          <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
            Use your <span className="text-foreground font-medium">@{ALLOWED_AUTH_EMAIL_DOMAIN}</span> Google account.
